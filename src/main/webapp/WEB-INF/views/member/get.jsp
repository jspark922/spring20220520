	...
	<div class="container">
		...
		<div class="row justify-content-center">
			<div class="col-12 col-lg-6">
				...
				<input class="form-control" id="idinput1" type="text" value="${member.id }" readonly /> <br />
				...
				가입일시 : <input class="form-control" type="datetime-local" value="${member.inserted }" readonly /> <br />
				</div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
	      <form id="form1" action="${appRoot }/member/remove" method="post">
	        <input class="form-control"type="hidden" value="${member.id }" name="id" />
	        <label for="passwordInput3" class="form-label">
	        암호 : 
	        </label>
	        <input id="passwordInput3" type="text" name="password" />
	      </form>
      </div>
